...
// classifier branches on, computed from Python 3.13.15's unicodedata (UCD 15.1.0)
// so the C++ agrees with tools/xlmr_tokenizer_ref.py by construction.
//
//   extend (Mn+Me)          343 ranges
//   spacing_mark (Mc)       182 ranges
//   control (Cc+Cf+Zl+Zp)   23 ranges
...
inline constexpr CpRange kExtend[] = {
...
inline constexpr int kExtend_n = 343;

inline constexpr CpRange kSpacingMark[] = {
...
inline constexpr int kSpacingMark_n = 182;

inline constexpr CpRange kControlCat[] = {
...
inline constexpr int kControlCat_n = 23;
