...
module {
  aie.device(npu2_1col) {
    ...
    aie.core(%core) {
      ...
      %v_push = arith.constant 0x00000000 : i32

      // CONTROL VARIANT: no control packet; the runtime sequence starts the
      // slab task itself. Isolates the data path from the packet mechanism.
