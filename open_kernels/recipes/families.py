...
def family_module(name: str) -> ModuleType:
    if name == "qwen36moe":
        ...
        return qwen36moe
    if name in ("qwen3", "llama3", "gemma3", "granite"):
        from . import dense
        return dense
    raise ValueError(f"no recipe for family {name!r} (have qwen36moe, qwen3, llama3, gemma3, granite)")
...
FAMILIES = ("qwen36moe", "qwen3", "llama3", "gemma3", "granite")
