# my-first-npu: section-3 vector * scalar, adapted from
# https://github.com/Xilinx/mlir-aie programming_guide/section-3
# SPDX-License-Identifier: Apache-2.0 WITH LLVM-exception
"""@iron.jit vector * scalar design targeting npu2 (AMD XDNA NPU)."""
...
def vector_scalar_mul(a_in: In, f_in: In, c_out: Out):
    ...
    def sequence(a, f, c, pin, pfactor, pout):
        pin.fill(a)
        pfactor.fill(f)
        pout.drain(c, wait=True)
